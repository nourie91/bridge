...
function cmdHelp() {
  brand();
  print(`  ${C.dim}Compiler-driven design generation in Figma${C.reset}`);
  print('');
  ...
  print(`    ${C.dim}/design-workflow make${C.reset}     Compile a component spec into Figma`);
  print(`    ${C.dim}/design-workflow fix${C.reset}      Validate, learn from corrections, iterate`);
  print(`    ${C.dim}/design-workflow done${C.reset}     Archive & ship`);
  print(`    ${C.dim}/design-workflow drop${C.reset}     Abandon with preserved recipes, learnings`);
